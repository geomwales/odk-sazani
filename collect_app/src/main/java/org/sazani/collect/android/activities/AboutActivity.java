...
import org.sazani.collect.android.adapters.AboutListAdapter;
...
public class AboutActivity extends CollectAbstractActivity implements
    ...
    private static final String GEOM_HTML_PATH = "file:///android_asset/sazani_geom_info.html";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int[][] items = {
                ...
                {R.drawable.ic_stars, R.string.geom_data, R.string.geom_data_msg},
        ...
        if (MultiClickGuard.allowClick(getClass().getName())) {
            switch (position) {
                ...
                case 4:
                    ...
                    intent.putExtra(CustomTabHelper.OPEN_URL, GEOM_HTML_PATH);
                    startActivity(intent);
                    }
                    break;
                case 5:
