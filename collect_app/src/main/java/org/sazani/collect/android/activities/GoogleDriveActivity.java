...
import org.sazani.collect.android.adapters.FileArrayAdapter;
import org.sazani.collect.android.application.Collect;
import org.sazani.collect.android.exception.MultipleFoldersFoundException;
import org.sazani.collect.android.injection.DaggerUtils;
import org.sazani.collect.android.listeners.GoogleDriveFormDownloadListener;
import org.sazani.collect.android.listeners.PermissionListener;
import org.sazani.collect.android.listeners.TaskListener;
import org.sazani.collect.android.logic.DriveListItem;
...
import org.sazani.collect.android.utilities.gdrive.DriveHelper;
...
import static org.sazani.collect.android.utilities.gdrive.GoogleAccountsManager.showSettingsDialog;
...
public class GoogleDriveActivity extends FormListActivity implements View.OnClickListener,
    ...
    private class GetFileTask extends
        ...
        private void downloadFile(@NonNull String fileId, String fileName) throws IOException {
            File file = new File(new StoragePathProvider().getDirPath(StorageSubdirectory.FORMS) + File.separator + fileName);
