...
package org.sazani.collect.android.activities;
...
import org.sazani.collect.android.audio.AudioControllerView;
import org.sazani.collect.android.dao.FormsDao;
import org.sazani.collect.android.dao.helpers.ContentResolverHelper;
import org.sazani.collect.android.dao.helpers.FormsDaoHelper;
import org.sazani.collect.android.dao.helpers.InstancesDaoHelper;
import org.sazani.collect.android.events.ReadPhoneStatePermissionRxEvent;
import org.sazani.collect.android.events.RxEventBus;
import org.sazani.collect.android.exception.JavaRosaException;
import org.sazani.collect.android.external.ExternalDataManager;
import org.sazani.collect.android.formentry.FormEntryMenuDelegate;
import org.sazani.collect.android.formentry.FormEntryViewModel;
import org.sazani.collect.android.formentry.FormIndexAnimationHandler;
import org.sazani.collect.android.formentry.FormLoadingDialogFragment;
import org.sazani.collect.android.formentry.ODKView;
import org.sazani.collect.android.formentry.QuitFormDialog;
import org.sazani.collect.android.formentry.audit.AuditEvent;
import org.sazani.collect.android.formentry.audit.AuditUtils;
import org.sazani.collect.android.formentry.audit.ChangesReasonPromptDialogFragment;
import org.sazani.collect.android.formentry.audit.IdentifyUserPromptDialogFragment;
import org.sazani.collect.android.formentry.audit.IdentityPromptViewModel;
import org.sazani.collect.android.formentry.backgroundlocation.BackgroundLocationManager;
import org.sazani.collect.android.formentry.backgroundlocation.BackgroundLocationViewModel;
import org.sazani.collect.android.formentry.repeats.AddRepeatDialog;
import org.sazani.collect.android.formentry.saving.FormSaveViewModel;
import org.sazani.collect.android.formentry.saving.SaveFormProgressDialogFragment;
import org.sazani.collect.android.fragments.MediaLoadingFragment;
import org.sazani.collect.android.fragments.dialogs.CustomDatePickerDialog;
import org.sazani.collect.android.fragments.dialogs.LocationProvidersDisabledDialog;
import org.sazani.collect.android.fragments.dialogs.NumberPickerDialog;
import org.sazani.collect.android.fragments.dialogs.ProgressDialogFragment;
import org.sazani.collect.android.fragments.dialogs.RankingWidgetDialog;
import org.sazani.collect.android.javarosawrapper.FormController;
import org.sazani.collect.android.javarosawrapper.FormController.FailedConstraint;
import org.sazani.collect.android.listeners.AdvanceToNextListener;
import org.sazani.collect.android.listeners.FormLoaderListener;
import org.sazani.collect.android.listeners.PermissionListener;
import org.sazani.collect.android.listeners.SavePointListener;
import org.sazani.collect.android.listeners.WidgetValueChangedListener;
import org.sazani.collect.android.logic.FormInfo;
import org.sazani.collect.android.logic.ImmutableDisplayableQuestion;
import org.sazani.collect.android.network.NetworkStateProvider;
import org.sazani.collect.android.preferences.AdminKeys;
import org.sazani.collect.android.preferences.AdminSharedPreferences;
import org.sazani.collect.android.preferences.GeneralKeys;
import org.sazani.collect.android.preferences.GeneralSharedPreferences;
import org.sazani.collect.android.provider.FormsProviderAPI.FormsColumns;
import org.sazani.collect.android.provider.InstanceProviderAPI.InstanceColumns;
import org.sazani.collect.android.storage.StorageInitializer;
import org.sazani.collect.android.storage.StoragePathProvider;
import org.sazani.collect.android.storage.StorageSubdirectory;
import org.sazani.collect.android.tasks.FormLoaderTask;
import org.sazani.collect.android.tasks.SaveFormIndexTask;
import org.sazani.collect.android.tasks.SaveFormToDisk;
import org.sazani.collect.android.tasks.SavePointTask;
import org.sazani.collect.android.upload.AutoSendWorker;
import org.sazani.collect.android.utilities.ApplicationConstants;
import org.sazani.collect.android.utilities.DestroyableLifecyleOwner;
import org.sazani.collect.android.utilities.DialogUtils;
import org.sazani.collect.android.utilities.FileUtils;
import org.sazani.collect.android.utilities.QuestionFontSizeUtils;
import org.sazani.collect.android.utilities.FormNameUtils;
import org.sazani.collect.android.utilities.ImageConverter;
import org.sazani.collect.android.utilities.MediaManager;
...
import org.sazani.collect.android.utilities.SnackbarUtils;
import org.sazani.collect.android.utilities.SoftKeyboardUtils;
import org.sazani.collect.android.utilities.ToastUtils;
import org.sazani.collect.android.widgets.DateTimeWidget;
import org.sazani.collect.android.widgets.QuestionWidget;
import org.sazani.collect.android.widgets.RangeWidget;
...
import static org.sazani.collect.android.analytics.AnalyticsEvents.LAUNCH_FORM_WITH_BG_LOCATION;
import static org.sazani.collect.android.analytics.AnalyticsEvents.SAVE_INCOMPLETE;
import static org.sazani.collect.android.preferences.AdminKeys.KEY_MOVING_BACKWARDS;
import static org.sazani.collect.android.utilities.AnimationUtils.areAnimationsEnabled;
import static org.sazani.collect.android.utilities.ApplicationConstants.RequestCodes;
import static org.sazani.collect.android.utilities.DialogUtils.getDialog;
import static org.sazani.collect.android.utilities.DialogUtils.showIfNotShowing;
import static org.sazani.collect.android.utilities.PermissionUtils.areStoragePermissionsGranted;
import static org.sazani.collect.android.utilities.PermissionUtils.finishAllActivities;
import static org.sazani.collect.android.utilities.ToastUtils.showLongToast;
import static org.sazani.collect.android.utilities.ToastUtils.showShortToast;
