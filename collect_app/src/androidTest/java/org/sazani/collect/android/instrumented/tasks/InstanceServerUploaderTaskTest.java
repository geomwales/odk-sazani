package org.sazani.collect.android.instrumented.tasks;
...
import org.sazani.collect.android.openrosa.OpenRosaConstants;
...
import org.sazani.collect.android.tasks.InstanceUploaderTask;
import org.sazani.collect.android.support.MockedServerTest;
...
import static org.sazani.collect.android.support.TestUtils.assertMatches;
import static org.sazani.collect.android.support.TestUtils.cleanUpTempFiles;
import static org.sazani.collect.android.support.TestUtils.createTempFile;
import static org.sazani.collect.android.support.TestUtils.resetInstancesContentProvider;
...
public class InstanceServerUploaderTaskTest extends MockedServerTest {
    ...
    public void shouldUploadAnInstance() throws Exception {
        ...
        HEAD: {
            ...
            assertMatches("org.sazani.collect.android/.* Dalvik/.*", r.getHeader("User-Agent"));
