...
import static org.sazani.collect.android.support.actions.NestedScrollToAction.nestedScrollTo;
import static org.sazani.collect.android.support.CustomMatchers.withIndex;
...
public class FieldListUpdateTest {
    ...
    public void questionsAppearingBeforeCurrentBinaryQuestion_ShouldNotChangeFocus() throws IOException {
        ...
        Bitmap icon = BitmapFactory.decodeResource(ApplicationProvider.getApplicationContext().getResources(), R.mipmap.sazani);
